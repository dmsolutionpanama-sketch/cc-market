...
import { 
  ...
  Send, Bookmark, Layers, PhoneCall, Sparkles, AlertTriangle, Check, Star
} from 'lucide-react';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-slate-950/80 backdrop-blur-md overflow-y-auto">
      <div className="relative w-full max-w-4xl bg-white rounded-3xl shadow-2xl border border-slate-200 overflow-hidden my-auto max-h-[92vh] flex flex-col">
        ...
        <div className="p-5 sm:p-7 overflow-y-auto space-y-6 flex-1 text-slate-800">
          ...
          {/* Evaluación por Marcas (1 a 5 Estrellas) */}
          <div className="bg-white border-2 border-slate-300 rounded-2xl p-5 shadow-xs">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4 pb-3 border-b border-slate-300">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-black text-slate-900 text-base">Evaluación por Marcas (1 a 5 Estrellas)</h3>
              </div>
            ...
            <div className="p-4 bg-amber-50/60 border border-amber-200 rounded-xl mb-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  <h4 className="font-black text-slate-900 text-sm">Selecciona tu Calificación (1 al 5)</h4>
                  <p className="text-xs text-slate-600">Haz clic en las estrellas para calificar el desempeño comercial de este creador.</p>
                </div>
